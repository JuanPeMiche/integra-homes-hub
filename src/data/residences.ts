...
export const mockResidences: Residence[] = [
  {
    ...
    description: "Residencial con más de 4 años de experiencia en cuidado del adulto mayor. Ofrece un ambiente cálido y familiar, con servicio completo al residente. Cuenta con habilitación de Bomberos y Salud Pública, habitaciones compartidas de 2 y 3 camas, y cuartos diferenciados para damas y caballeros.",
    services: [
      "Atención 24 horas",
  ...
  },
  {
    ...
    description: "Residencial orientado al Modelo de Atención Centrado en la Persona (ACP), con un enfoque humanizado y de alta calidad humana. Se ubica en una amplia propiedad con espacios verdes, ofreciendo un entorno saludable y contacto con la naturaleza. Su misión es brindar cuidados de excelencia en un ambiente de paz, seguridad y confort.",
    services: [
  ...
  },
  {
    ...
    description: "Residencial mixto habilitado por MSP, especialmente diseñado para el cuidado de personas mayores. La casa cuenta con adaptaciones como agarraderas, rampas, ambientes calefaccionados y salidas de emergencia señalizadas, brindando seguridad y accesibilidad.",
    services: [
  ...
  },
  {
    ...
    city: "Prado",
    province: "Montevideo",
    address: "Av. Dr. Juan Carlos Blanco 3485, Prado, Montevideo",
    price: 0,
    priceRange: "Consultar",
    capacity: 30,
    rating: 4.6,
